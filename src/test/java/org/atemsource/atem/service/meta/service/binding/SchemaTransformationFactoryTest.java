...
import org.atemsource.atem.service.meta.service.binding.schema.SchemaTransformationFactory;
...
import org.springframework.test.context.junit4.SpringJUnit4ClassRunner;
	...
	public class SchemaTransformationFactoryTest {
		...
		public void testSimpleType() {
			...
			ObjectNode schema = (ObjectNode) schemaTransformationFactory.getTransformation().getAB().convert(test1, ctx);
		...
		public void testPolymorphismType() {
			...
			SimpleTransformationContext ctx = new SimpleTransformationContext(entityTypeRepository);
			ObjectNode schema = (ObjectNode) schemaTransformationFactory.getTransformation().getAB().convert(test4, ctx);
			System.out.println(schema);
		}
