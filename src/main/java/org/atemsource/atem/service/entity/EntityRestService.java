...
public class EntityRestService
{
	...
	private Object createEntity(String type, JsonNode entity)
	{
		...
		UniTransformation<JsonNode, Object> transformation =
			(UniTransformation<JsonNode, Object>) derivedType.getTransformation().getBA();
		// TODO insert should be able to return validation errors
		Object transformedEntity = transformation.convert(entity, new JacksonTransformationContext(entityTypeRepository));
